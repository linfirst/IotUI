...
public class HumFragment extends Fragment {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        view = inflater.inflate(R.layout.fragment_hum,container,false);
        initRecyclerView();
...
//        recerver();
    ...
    public void addHumData(String temNumber){
        if (adapter!=null&&recyclerView!=null){
            adapter.setData(Integer.valueOf(analysisData.getHum(temNumber)));
            recyclerView.scrollToPosition(data.size()-1);
            recyclerView.setAdapter(adapter);
        }
    }
